...
def main():
    ...
    try:
        ...
        filename = sys.argv[1]
        print ("File getting attached is = {}.".format(filename))
    except:
        print("did not have a file passed from command line")
        #print("Canceling sending the Email")
    
    try:
        open(filename)
        print ("I can find and open the file")
    except:
        print("did not find the file passed from command line")
        print("Canceling sending the Email")
    else:
